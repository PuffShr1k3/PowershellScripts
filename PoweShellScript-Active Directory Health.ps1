# Script Description: Active Directory Health and replication report. Overall info for domain administration and management.
...
function Get-DomainInfo($DomainName)
    ...
    Clear-Host
    Write-Host -ForegroundColor white -BackgroundColor black "Active Directory report v0.2 - Author Glen Janjetich"
