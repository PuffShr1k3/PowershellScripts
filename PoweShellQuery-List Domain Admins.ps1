# Script Description: Identifies all domain administrators in the domain.
...
get-adgroupmember -Identity "domain Admins" | Out-GridView
#To output to a csv file, remove the '#' from the next fron of the following ine and insert a '# in front of the above line.
#get-adgroupmember -Identity "Domain Admins" | Export-csv "C:\List of Domain Admins.csv"
