# Script Description: Identifies all Schema administrators in the domain.
...
get-adgroupmember -Identity "Schema Admins" | Out-GridView
#To output to a csv file, remove the '#' from the next front of the following ine and insert a '# in front of the above line.
#get-adgroupmember -Identity "Schema Admins" | Export-csv "C:\List of Domain Admins.csv"
